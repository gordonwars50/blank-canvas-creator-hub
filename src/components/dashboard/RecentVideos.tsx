...
const RecentVideos: React.FC = () => {
  ...
  return <div className="border border-gray-900 rounded-lg p-6 bg-zinc-950">
    ...
    <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        return <motion.div key={video.id} initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: index * 0.1
                ...
                <GlowCard glowColor="red" customSize={true} className="bg-gray-900/50 border border-gray-800 rounded-lg p-4 hover:border-gray-700 transition-colors w-full h-auto aspect-auto grid-rows-none gap-0">
                  <div className="flex gap-4">
                    {/* Thumbnail */}
                    <div className="relative flex-shrink-0">
                      <img src={video.thumbnail} alt={video.title} className="w-32 h-18 object-cover rounded-lg" />
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <AvatarGroupWithTooltips avatars={video.teamMembers} maxAvatars={3} />
