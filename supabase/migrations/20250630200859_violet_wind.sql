...
-- Projects policies with existence checks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Scenes policies with existence checks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'scenes' AND policyname = 'Users can view scenes of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'scenes' AND policyname = 'Users can update scenes of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'scenes' AND policyname = 'Users can create scenes for their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'scenes' AND policyname = 'Users can delete scenes of their own projects'
  ) THEN
...
-- Shots policies with existence checks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'shots' AND policyname = 'Users can view shots of their own scenes'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'shots' AND policyname = 'Users can update shots of their own scenes'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'shots' AND policyname = 'Users can create shots for their own scenes'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'shots' AND policyname = 'Users can delete shots of their own scenes'
  ) THEN
...
-- Team assignments policies with existence checks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'team_assignments' AND policyname = 'Users can view team assignments of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'team_assignments' AND policyname = 'Users can update team assignments of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'team_assignments' AND policyname = 'Users can create team assignments for their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'team_assignments' AND policyname = 'Users can delete team assignments of their own projects'
  ) THEN
...
-- Storyboard files policies with existence checks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'storyboard_files' AND policyname = 'Users can view storyboard files of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'storyboard_files' AND policyname = 'Users can update storyboard files of their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'storyboard_files' AND policyname = 'Users can create storyboard files for their own projects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'storyboard_files' AND policyname = 'Users can delete storyboard files of their own projects'
  ) THEN
